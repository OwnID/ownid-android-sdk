...
See [complete example](../demo-direct-integration/src/main/java/com/ownid/demo/integration/DemoApp.kt)
...
Check [complete example](../demo-direct-integration/src/main/res/layout/fragment_create.xml)
...
See [complete example](../demo-direct-integration/src/main/java/com/ownid/demo/integration/ui/fragment/CreateFragment.kt)
                ...
                is OwnIdRegisterFlow.Response -> {
                    when (ownIdFlowEvent.payload.type) { 
                        ...
                        OwnIdPayload.Type.Login -> { 
                            // Login user with your identity platform using OwnId Data 
...
1. **Password replacing button**
    ...
    Check [complete example](../demo-direct-integration/src/main/res/layout/fragment_login.xml)
...
See [complete example](../demo-direct-integration/src/main/java/com/ownid/demo/integration/ui/fragment/LoginFragment.kt)
        ...
        ownIdViewModel.events.observe(viewLifecycleOwner) { ownIdFlowEvent ->
            when (ownIdFlowEvent) {
                ...
                is OwnIdLoginFlow.Response -> {
                    // Login user with your identity platform using OwnId Data from this event (ownIdFlowEvent.payload.data)
                }
