...
import com.ownid.sdk.internal.feature.flow.steps.fido.FidoLoginAuthStep
import com.ownid.sdk.internal.feature.flow.steps.fido.FidoRegisterAuthStep
import com.ownid.sdk.internal.feature.flow.steps.idcollect.IdCollectStep
import com.ownid.sdk.internal.feature.flow.steps.otp.OtpAuthStep
...
internal abstract class AbstractStep(
    ...
    protected fun sendMetric(type: Metric.EventType, action: String, errorMessage: String? = null, errorCode: String? = null) {
        val returningUser = runBlocking { ownIdFlowData.ownIdCore.repository.getLoginId() }.isNotEmpty()
        ownIdFlowData.ownIdCore.eventsService.sendMetric(
            ownIdFlowData.flowType, type, action, Metadata(returningUser = returningUser), getMetricSource(), errorMessage, errorCode
        )
    }
