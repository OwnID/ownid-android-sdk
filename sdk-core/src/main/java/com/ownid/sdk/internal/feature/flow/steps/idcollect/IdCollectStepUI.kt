...
import com.ownid.sdk.internal.feature.flow.AbstractStepUI
...
internal class IdCollectStepUI : AbstractStepUI<IdCollectStep>(R.layout.com_ownid_sdk_internal_ui_id_collect) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        when (currentStep.ownIdFlowData.loginId) {
            ...
            is OwnIdFlowLoginId.PhoneNumber -> {
            ...
            is OwnIdFlowLoginId.UserName -> TODO()
        }
        ...
        currentStep.state.observe(viewLifecycleOwner) { state ->
            ...
            if (currentStep.ownIdFlowData.loginId is OwnIdFlowLoginId.PhoneNumber) {
    ...
    private object LocaleKeys {
            ...
            if (ownIdFlowData.ownIdCore.configuration.isFidoPossible()) OwnIdLocaleKey(*prefix, ownIdFlowData.loginId.localeKey, "title")
                ...
                .withFallback(
                    when (ownIdFlowData.loginId) {
                        is OwnIdFlowLoginId.Email -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_title_email_no_biometrics
                        is OwnIdFlowLoginId.PhoneNumber -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_title_phone_no_biometrics
                        is OwnIdFlowLoginId.UserName -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_title_user_id_no_biometrics
                    }
                )
        ...
        internal fun getMessageKey(ownIdFlowData: OwnIdFlowData) =
            if (ownIdFlowData.ownIdCore.configuration.isFidoPossible()) OwnIdLocaleKey(*prefix, ownIdFlowData.loginId.localeKey, "message")
                .withFallback(
                    when (ownIdFlowData.loginId) {
                        is OwnIdFlowLoginId.Email -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_message_email
                        is OwnIdFlowLoginId.PhoneNumber -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_message_phone
                        is OwnIdFlowLoginId.UserName -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_message_user_id
                    }
                )
        ...
        internal fun getErrorKey(ownIdFlowData: OwnIdFlowData) =
            OwnIdLocaleKey(*prefix, ownIdFlowData.loginId.localeKey, "error")
                .withFallback(
                    when (ownIdFlowData.loginId) {
                        is OwnIdFlowLoginId.Email -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_error_email
                        is OwnIdFlowLoginId.PhoneNumber -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_error_phone
                        is OwnIdFlowLoginId.UserName -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_error_user_id
                    }
                )
    }
