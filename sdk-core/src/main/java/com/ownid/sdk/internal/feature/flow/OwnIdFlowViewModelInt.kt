...
import com.ownid.sdk.internal.feature.flow.steps.InitStep

@InternalOwnIdAPI
@RestrictTo(RestrictTo.Scope.LIBRARY_GROUP)
public class OwnIdFlowViewModelInt : ViewModel() {
    ...
    @MainThread
    internal fun startFlow(ownIdFlowData: OwnIdFlowData) {
