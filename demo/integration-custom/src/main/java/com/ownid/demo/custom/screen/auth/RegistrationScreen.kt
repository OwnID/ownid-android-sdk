...
import com.ownid.demo.custom.CustomIntegration
        ...
        Button(
            onClick = {
                if (ownIdRegisterViewModel.isReadyToRegister) {
                    ownIdRegisterViewModel.register(email.value, CustomIntegration.IntegrationRegistrationParameters(name.value))
                } else {
