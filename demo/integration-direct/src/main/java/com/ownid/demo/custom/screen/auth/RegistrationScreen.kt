...
fun RegistrationScreen(
    doRegistration: (String, String, String) -> Unit,
    onOwnIdResponse: (OwnIdFlowResponse) -> Unit,
    ...
    Column(
        ...
        Row(modifier = Modifier.padding(horizontal = 16.dp, vertical = 8.dp)) {
            OwnIdRegisterButton(
                ...
                onResponse = { response ->
                    ...
                    if (response.loginId.isNotBlank()) email.value = response.loginId

                    onOwnIdResponse.invoke(response)
                },
        ...
        Button(
            onClick = { doRegistration.invoke(name.value, email.value, password.value) },
            modifier = Modifier
                .fillMaxWidth()
                .padding(horizontal = 16.dp, vertical = 8.dp),
        ) {
