...
import com.ownid.sdk.internal.feature.webflow.OwnIdFlowWebViewClient
...
@Config(sdk = [33])
public class OwnIdFlowWebViewClientTest {
    ...
    private lateinit var webViewClient: OwnIdFlowWebViewClient
    ...
    public fun setUp() {
        ...
        webViewClient = OwnIdFlowWebViewClient(webView, onError)
    }
