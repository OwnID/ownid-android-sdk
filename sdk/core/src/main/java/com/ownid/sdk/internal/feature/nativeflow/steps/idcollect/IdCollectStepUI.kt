...
internal class IdCollectStepUI : AbstractStepUI<IdCollectStep>(R.layout.com_ownid_sdk_internal_ui_id_collect) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        when (currentStep.ownIdNativeFlowData.loginId) {
            is OwnIdNativeFlowLoginId.Email -> {
                ...
                idEditText.setText(currentStep.ownIdNativeFlowData.loginId.value)
            }

            is OwnIdNativeFlowLoginId.PhoneNumber -> {
                ...
                val modalListPopup = ListPopupWindow(requireContext()).also { popup ->
                    ...
                    val adapter = ArrayAdapter(
                        ...
                        currentStep.ownIdNativeFlowData.ownIdCore.configuration.server.phoneCodes
                    )
            ...
            is OwnIdNativeFlowLoginId.UserName -> TODO()
        }
        ...
        currentStep.state.observe(viewLifecycleOwner) { state ->
            ...
            if (currentStep.ownIdNativeFlowData.loginId is OwnIdNativeFlowLoginId.PhoneNumber) {
            ...
            if (state.error == null) {
                ...
                val ownIdUserError = when (state.error) {
                    is IdCollectStep.IdCollectStepWrongLoginId -> {
                        val userMessage = getString(LocaleKeys.getErrorKey(currentStep.ownIdNativeFlowData))
                        OwnIdUserError(OwnIdNativeFlowError.CodeLocal.INVALID_LOGIN_ID, userMessage, "User entered invalid login id")
                    }
    ...
    override fun setStrings() {
        ...
        titleTextView.text = getString(LocaleKeys.getTitleKey(currentStep.ownIdNativeFlowData))
        messageTextView.text = getString(LocaleKeys.getMessageKey(currentStep.ownIdNativeFlowData))
        cancelButton.text = getString(LocaleKeys.getCancelKey(currentStep.ownIdNativeFlowData))
        continueButton.text = getString(LocaleKeys.getContinueKey(currentStep.ownIdNativeFlowData))
    ...
    private object LocaleKeys {
        ...
        @JvmStatic
        internal fun getTitleKey(ownIdNativeFlowData: OwnIdNativeFlowData) =
            if (ownIdNativeFlowData.ownIdCore.configuration.isFidoPossible()) OwnIdLocaleKey(*prefix, ownIdNativeFlowData.loginId.localeKey, "title")
                .withFallback(R.string.com_ownid_sdk_internal_ui_steps_id_collect_title)
            else OwnIdLocaleKey(*prefix, ownIdNativeFlowData.loginId.localeKey, "no-biometrics", "title")
                .withFallback(
                    when (ownIdNativeFlowData.loginId) {
                        is OwnIdNativeFlowLoginId.Email -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_title_email_no_biometrics
                        is OwnIdNativeFlowLoginId.PhoneNumber -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_title_phone_no_biometrics
                        is OwnIdNativeFlowLoginId.UserName -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_title_user_id_no_biometrics
                    }
                )

        @JvmStatic
        internal fun getMessageKey(ownIdNativeFlowData: OwnIdNativeFlowData) =
            if (ownIdNativeFlowData.ownIdCore.configuration.isFidoPossible()) OwnIdLocaleKey(*prefix, ownIdNativeFlowData.loginId.localeKey, "message")
                .withFallback(
                    when (ownIdNativeFlowData.loginId) {
                        is OwnIdNativeFlowLoginId.Email -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_message_email
                        is OwnIdNativeFlowLoginId.PhoneNumber -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_message_phone
                        is OwnIdNativeFlowLoginId.UserName -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_message_user_id
                    }
                )
            else OwnIdLocaleKey(*prefix, ownIdNativeFlowData.loginId.localeKey, "no-biometrics", "message")
                .withFallback(R.string.com_ownid_sdk_internal_ui_steps_id_collect_message_no_biometrics)

        @JvmStatic
        internal fun getCancelKey(ownIdNativeFlowData: OwnIdNativeFlowData) =
            OwnIdLocaleKey(*prefix, ownIdNativeFlowData.loginId.localeKey, "cancel")
                .withFallback(R.string.com_ownid_sdk_internal_ui_steps_cancel)

        @JvmStatic
        internal fun getContinueKey(ownIdNativeFlowData: OwnIdNativeFlowData) =
            OwnIdLocaleKey(*prefix, ownIdNativeFlowData.loginId.localeKey, "cta")
                .withFallback(R.string.com_ownid_sdk_internal_ui_steps_id_collect_cta)

        @JvmStatic
        internal fun getErrorKey(ownIdNativeFlowData: OwnIdNativeFlowData) =
            OwnIdLocaleKey(*prefix, ownIdNativeFlowData.loginId.localeKey, "error")
                .withFallback(
                    when (ownIdNativeFlowData.loginId) {
                        is OwnIdNativeFlowLoginId.Email -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_error_email
                        is OwnIdNativeFlowLoginId.PhoneNumber -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_error_phone
                        is OwnIdNativeFlowLoginId.UserName -> R.string.com_ownid_sdk_internal_ui_steps_id_collect_error_user_id
                    }
                )
    }
