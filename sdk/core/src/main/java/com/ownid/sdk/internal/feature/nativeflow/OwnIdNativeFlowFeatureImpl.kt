...
import com.ownid.sdk.internal.feature.nativeflow.OwnIdNativeFlowFeature.Companion.toOwnIdFlowData
...
@InternalOwnIdAPI
internal class OwnIdNativeFlowFeatureImpl : OwnIdNativeFlowFeature {

    private var currentStep: String? = null

    override fun onCreate(activity: AppCompatActivity, savedInstanceState: Bundle?) {
        currentStep = savedInstanceState?.getString(OwnIdNativeFlowFeature.KEY_CURRENT_STEP)
        ...
        val viewModel = ViewModelProvider(activity).get(OwnIdNativeFlowViewModelInt::class.java)
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        outState.putString(OwnIdNativeFlowFeature.KEY_CURRENT_STEP, currentStep)
    }
