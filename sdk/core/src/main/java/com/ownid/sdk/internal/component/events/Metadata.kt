...
public data class Metadata(
    ...
    private val resultType: ResultType? = null,
    private val deviceSecurityStatus: JSONObject? = null,
) {
    ...
    @InternalOwnIdAPI
    public sealed class ResultType(internal val value: String, internal val data: String) {
        @InternalOwnIdAPI
        public class Success(data: String) : ResultType("success", data)
        @InternalOwnIdAPI
        public class Failure(data: String) : ResultType("failure", data)
    }
...
//            if (returningUser != null) put("returningUser", returningUser)
            ...
            if (deviceSecurityStatus != null) put("deviceSecurityStatus", deviceSecurityStatus)
        }
    }.getOrElse {
