...
import com.ownid.sdk.internal.feature.webflow.OwnIdFlowFeatureImpl.JsConstants.isJSException
import com.ownid.sdk.internal.feature.webflow.OwnIdFlowFeatureImpl.JsConstants.isJSLoadError

@InternalOwnIdAPI
internal class FlowWebViewClient(private val webView: WebView, private val onError: (OwnIdException) -> Unit) : WebViewClient() {
